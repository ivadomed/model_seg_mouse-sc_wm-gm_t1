...
~~~
python /path/to/repo/convert_bids_to_nnunet.py --path-data /path/to/data --path-out /path/to/nnUNet_raw --taskname TASK-NAME --tasknumber DATASET-ID
~~~
...
> Example for Dataset 101, on 3d_fullres config with 5 folds: CUDA_VISIBLE_DEVICES=2 nnUNetv2_train 101 3d_fullres 5 --npz

You can track the progress of the model with: nnUNet_results/DATASET_ID/nnUNetTrainer__nnUNetPlans__CONFIG/fold_FOLD/progress.png
